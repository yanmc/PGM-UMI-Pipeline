...
def get_primer_and_cut_before_UMI(handle,recombanation_info_dict):
	...
	cut_berfore_UMI_8_fasta = open("%s/%s_cut_berfore_UMI_8.fasta"%(prj_tree.split, fname), "w")
	cut_berfore_UMI_less8_fasta = open("%s/%s_cut_berfore_UMI_less8.fasta"%(prj_tree.split, fname), "w")
